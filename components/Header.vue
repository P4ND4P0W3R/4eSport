...
<template>
  <div class="fixed top-0 left-0 right-0 z-10">
    <header class="w-full border-b-[1px] border-white/20 backdrop-blur-[2px] text-white bg-[#1C1C1C]/70">
      <a href="https://discord.com/channels/252550911187091457/1218599398288789535" target="_blank"
        ...
        Participe au tournoi Fortnite le 6 avril !
      </a>
      <div class="w-[95%] md:w-[90%] lg:w-[80%] max-w-[1500px] m-auto flex justify-between items-center py-1 md:py-2">
        ...
        <nav class="text-sm sm:text-base flex justify-between gap-3 sm:gap-8 m-auto md:m-0">
          <NuxtLink to="/"
            class="block md:hidden link-underline hover:text-[#15c584] transition-all ease-in-out delay-75">
            4eSport
          </NuxtLink>
          ...
          <NuxtLink to="/cotisation"
            class="link-underline hover:text-[#15c584] transition-all ease-in-out delay-75 flex">Cotisation
...
.link-underline {
  ...
  background-image: linear-gradient(transparent, transparent), linear-gradient(rgb(21, 197, 132), rgb(21, 197, 132));
